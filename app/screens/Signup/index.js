...
const Signup = ({ navigation }) => {
    ...
    const signUpUser = () => {
        ...
        if(username === ''){
            setState(prevState => ({ ...prevState, usernameError: true, usernameErrorMessage: 'Username must be inserted' }));
            error++;
        }
        ...
        <ScrollView style={{ backgroundColor: 'white' }}>
                ...
                <View style={styles.formCenter}>
                    ...
                    <View roundedc style={styles.inputitem}>
                        ...
                        <TextInput 
                            ...
                            onChangeText={(firstname) => setState(prevState => ({ ...prevState, firstname, firstnameError:false }))} 
                ...
                <View style={styles.formCenter}>
                    ...
                    <View roundedc style={styles.inputitem}>
                        ...
                        <TextInput 
                            ...
                            style={styles.textBox} 
                            placeholderTextColor={"#A9A9A9"} 
                            onChangeText={(lastname) => setState(prevState => ({ ...prevState, lastname, lastnameError:false }))} 
                ...
                <View style={styles.formCenter}>
                    ...
                    <View roundedc style={styles.inputitem}>
                        ...
                        <TextInput 
                            ...
                            autoCapitalize="none" 
                            onChangeText={(email) => setState(prevState => ({ ...prevState, email, emailError:false }))}
                        />
                    </View>
            ...
            <View style={[styles.formLine, { paddingTop: 5 }]}>
                <View style={styles.formCenter}>
                    ...
                    <View roundedc style={[styles.inputitem, { flex: 1, justifyContent: 'center', alignItems: 'center' }]}>
                        ...
                        {/* <TextInput 
                            ...
                            returnKeyType="done" 
                            onChangeText={(phone) => setState(prevState => ({ ...prevState, phone, phoneError:false }))} 
                            autoComplete="tel"
                        /> */}
                        <PhoneInput
                            ref={phoneInput}
                            ...
                            returnKeyType="done" 
                            onChangeFormattedText={(phone) => setState(prevState => ({ ...prevState, phone, phoneError:false }))}
                        />
                        {state.isKeyboardOpen && Platform.OS === "ios" && (
                            <TouchableOpacity activeOpacity={0.8} style={styles.touchableButton} onPress={dismissKeyboard}>
                                <MaterialCommunityIcons name={'keyboard-off'} color={'#A9A9A9'} size={22} style={[styles.keyboardIcon]}/>
                ...
                <View style={styles.formCenter}>
                    ...
                    <View roundedc style={styles.inputitem}>
                        ...
                        <TextInput 
                            ...
                            style={styles.textBox} 
                            placeholderTextColor={"#A9A9A9"} 
                            onChangeText={(username) => setState(prevState => ({ ...prevState, username, usernameError:false }))} 
                ...
                <View style={styles.formCenter}>
                    ...
                    <View roundedc style={styles.inputitem}>
                        ...
                        <TextInput 
                            ...
                            style={styles.textBox} 
                            placeholderTextColor={"#A9A9A9"} 
                            onChangeText={(referralCode) => setState(prevState => ({ ...prevState, referralCode, referralCodeError:false }))} 
                        />
                        {state.isKeyboardOpen && Platform.OS === "ios" && (
                            <TouchableOpacity activeOpacity={0.8} style={styles.touchableButton} onPress={dismissKeyboard}>
                                <MaterialCommunityIcons name={'keyboard-off'} color={'#A9A9A9'} size={22} style={[styles.keyboardIcon]}/>
                ...
                <View style={styles.formCenter}>
                    ...
                    <View roundedc style={styles.inputitem}>
                        ...
                        <TextInput 
                            ...
                            style={styles.textBox} 
                            placeholderTextColor={"#A9A9A9"} 
                            onChangeText={(password) => setState(prevState => ({ ...prevState, password, passwordError:false }))}
                        />
                ...
                <View style={styles.formCenter}>
                    ...
                    <View roundedc style={styles.inputitem}>
                        ...
                        <TextInput 
                            ...
                            style={styles.textBox} 
                            placeholderTextColor={"#A9A9A9"} 
                            onChangeText={(confirmPassword) => setState(prevState => ({ ...prevState, confirmPassword, confirmPasswordError:false }))}
                        />
