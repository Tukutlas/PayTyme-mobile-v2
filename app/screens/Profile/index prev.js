...
export default class Profile extends Component {
    ...
    async logout(){
        ...
        const routeName = 'Signin'; // Fallback to 'Signin' if initialRoute is not set

        this.props.navigation.dispatch(
            CommonActions.reset({
                index: 0, // Reset to the first route
                routes: [
                    { name: routeName } // Use the valid route name
                ],
            })
        );
    }
            ...
            <>
                <TouchableWithoutFeedback onPress={() => this.setState({isModalVisible: false, deleteModalVisible: false})}>
                    <View style={styles.container}>
                        ...
                        <TouchableOpacity style={[styles.flexx,{backgroundColor:'#E0EBEC', width: '50%', marginLeft: '25%'}]}  onPress={() => {this.setState({logoutModalVisible: true})}}>
                            ...
                            >
                                <View style={{ flex: 1, alignItems: 'center' , justifyContent: 'center', backgroundColor: 'rgba(0, 0, 0, 0.6)'}}>
                                    ...
                                    <View style={{ backgroundColor: 'white', width: '100%', marginBottom: 0, borderRadius: 20}}>
                                        ...
                                        <View style={{alignSelf: "center", marginTop: '4%', flexDirection:'row', height: '10%',}}>
                                            <TouchableOpacity info style={{width: '40%', height: '90%', borderRadius: 15, borderWidth: 2, borderColor: "#0C0C54",  alignSelf: "center", justifyContent: "center", marginRight: '5%'}} onPress={() => { this.unlinkDevice() }}>
                                                <Text autoCapitalize="words" style={styles.cancelButton}>
                                                    Deactivate
                                                </Text>
                                            </TouchableOpacity>
                                            <TouchableOpacity info style={{width: '40%', height: '90%', backgroundColor: "#0C0C54", borderWidth: 2, borderRadius: 15, borderColor: "#0C0C54", alignSelf: "center", justifyContent: "center",}} onPress={() => { this.logout() }}>
                                                <Text autoCapitalize="words" style={styles.loginButton}>
                                                    Sign out
                                                </Text>
                                            </TouchableOpacity>
