    ...
    constructor(props) {
        ...
        this.state = {
            ...
            bettingOptions: [
                ...
                { label: 'Bet9ja_Agent', value: 'Bet9ja_Agent', icon: () => <Image source={require('../../Images/Betting/bet9ja.png')} style={{ width: 30, height: 30 }} /> },
                ...
                { label: 'GreenLotto', value: 'GreenLotto', icon: () => <Image source={require('../../Images/Betting/greenlotto.png')} style={{ width: 30, height: 30 }} /> },
                { label: 'Hallabet', value: 'Hallabet', icon: () => <Image source={require('../../Images/Betting/hallabet.png')} style={{ width: 30, height: 30 }} /> },
                ...
                { label: 'MLotto', value: 'MLotto', icon: () => <Image source={require('../../Images/Betting/mlotto.png')} style={{ width: 30, height: 30 }} /> },
                { label: 'MSport', value: 'MSport', icon: () => <Image source={require('../../Images/Betting/msport.png')} style={{ width: 30, height: 30 }} /> },
                ...
                { label: 'Paripesa', value: 'Paripesa', icon: () => <Image source={require('../../Images/Betting/paripesa.png')} style={{ width: 30, height: 30 }} /> },
                { label: 'SportyBet', value: 'SportyBet', icon: () => <Image source={require('../../Images/Betting/sportybet.png')} style={{ width: 30, height: 30 }} /> },
                { label: 'SupaBets', value: 'SupaBet', icon: () => <Image source={require('../../Images/Betting/supabet.jpg')} style={{ width: 30, height: 30 }} /> },
                { label: 'WazoBet', value: 'WazoBet', icon: () => <Image source={require('../../Images/Betting/wazobet.png')} style={{ width: 30, height: 30 }} /> },
                { label: 'WesternLotto', value: 'WesternLotto', icon: () => <Image source={require('../../Images/Betting/westernlotto.png')} style={{ width: 30, height: 30 }} /> },
            ],
            bettingError: false,
            bettingErrorMessage: '',
            customerName: '',
